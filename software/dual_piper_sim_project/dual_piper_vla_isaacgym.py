...
# ==========================================
    ...
    while not gym.query_viewer_has_closed(viewer):
        ...
        # 🧠 自动插值引擎
        # ==========================================
        # 🧠 自动插值引擎与数据采集 (完全替换你的 if AUTO_PLAY_MODE 块)
        # ==========================================
        if AUTO_PLAY_MODE:
            # 1. 物理时间计算与分段变速
            ...
            # 💥 防空帧崩溃保护：如果刚启动时摄像机没准备好，直接跳过本帧不保存！
